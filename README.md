...
## Dataset
- **Source**: WorldQuant University - Applied Data Science Lab (Real Estate Market Data)
- **Size**: 22,844 rows / 7 features
- **Scope**: National coverage with state-level granularity
